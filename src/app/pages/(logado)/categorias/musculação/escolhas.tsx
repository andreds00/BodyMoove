...
export default function LocaisMusculação() {
  const router = useRouter();

  const locais = [
    { nome: 'Mob Gym', distancia: '2 KM' },
    { nome: 'Cross Osasco', distancia: '3 KM' },
    { nome: 'Python', distancia: '7 KM' },
  ];

  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.bannerText}>Crossfit</Text>
