...
export default function LocaisCorrida() {
    const router = useRouter();
  const locais = [
    { nome: 'Athos Running', distancia: '2 KM de distância' },
    { nome: 'Moris', distancia: '3,6 KM de distância' },
    { nome: 'Red Fit', distancia: '7 KM de distância' },
  ];
