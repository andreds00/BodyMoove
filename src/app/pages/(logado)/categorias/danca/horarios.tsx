...
export default function HorariosDanca() {
    const router = useRouter();
  const horarios = [
    { hora: '7h00', nivel: 'Iniciante' },
    { hora: '9h20', nivel: 'Intermediário' },
    { hora: '10h30', nivel: 'Iniciante' },
    { hora: '15h30', nivel: 'Intermediário' },
    { hora: '16h40', nivel: 'Avançado' },
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.local}>Espaço Premiere</Text>
