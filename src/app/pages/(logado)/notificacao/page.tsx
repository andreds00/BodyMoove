  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top", "left", "right"]}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <TouchableOpacity style={styles.notificationBox} onPress={handleConfirmacao} accessibilityRole="button">
          <Text style={styles.notificationText}>
            Parabéns! Você acabou de agendar no Espaço Premiere uma aula de Fit Dance!{"\n"}
            Clique aqui para confirmar
          </Text>
          <Text style={styles.arrow} accessibilityLabel="abrir">{">"}</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.notificationBox} accessibilityRole="button">
