...
export default function InformacoesSpinning() {
    const router = useRouter();
  return (
    <SafeAreaView style={styles.container}>
   
      <View style={styles.banner}>
        <Text style={styles.bannerText}> Treino de HIIT Avançado  - 16h00</Text>
      </View>

     
      <TouchableOpacity style={styles.button}>
        <Ionicons name="location-outline" size={20} color="#D9D9D9" />
        <Text style={styles.buttonText}>Aayo Academy</Text>
        <MaterialIcons name="arrow-forward-ios" size={18} color="#D9D9D9" />
      </TouchableOpacity>

      <TouchableOpacity style={styles.button}>
        <Ionicons name="person-outline" size={20} color="#D9D9D9" />
        <Text style={styles.buttonText}>Instrutor Pietro Moraes</Text>
      </TouchableOpacity>
