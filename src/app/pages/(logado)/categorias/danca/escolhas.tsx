...
export default function LocaisDanca() {
    const router = useRouter();
  const locais = [
    { nome: 'Espaço Premiere', distancia: '2 KM de distância' },
    { nome: 'Passos em Foco', distancia: '3 KM de distância' },
    { nome: 'Moving Dance', distancia: '7 KM de distância' },
  ];
