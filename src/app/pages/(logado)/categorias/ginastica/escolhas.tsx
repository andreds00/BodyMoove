...
export default function LocaisGinastica() {
    const router = useRouter();
  const locais = [
    { nome: 'CPN Aqua', distancia: '1.8 KM de distância' },
    { nome: 'Água Academy', distancia: '4 KM de distância' },
    { nome: 'ACM', distancia: '8 KM de distância' },
  ];
